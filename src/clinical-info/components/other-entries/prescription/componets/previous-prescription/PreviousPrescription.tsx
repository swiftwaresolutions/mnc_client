...
const PreviousPrescription = ({ show, onHide, previousPrescriptionNameList, previousPrescriptionSelectedValue, handlePreviousPrescrionSelected, handleMapPrevMed }: any) => {
            ...
            >
                <Modal.Header>
                    <Row className='justify-content-around w-100'>
                        <Col><Modal.Title id="contained-modal-title-vcenter">Previous Prescription </Modal.Title></Col>
                        <Col className='text-center'><Button variant='outline-info' onClick={() => handleMapPrevMed()} disabled={previousPrescriptionSelectedValue.length == 0 ? true : false}>Add Prescription</Button></Col>

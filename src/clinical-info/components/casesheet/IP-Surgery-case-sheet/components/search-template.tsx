...
const SearchTemplate = ({tempId,fieldName,handleClose,setSearchTemplateShow}: any) => {
    ...
    const getCaseSheetTemplates = async () => {
        try {
            let result = await caseSheetApiService.getCaseSheetTemplate(3, tempId);
            ...
            <Modal.Header>
                <Row className="d-flex justify-contant-between w-100">
                    ...
                    <Col className="d-flex justify-content-end">
                        <Button variant="outline-info mx-2" onClick={() => handleClose(templateDetails, tempId,fieldName)}>Add Template</Button>

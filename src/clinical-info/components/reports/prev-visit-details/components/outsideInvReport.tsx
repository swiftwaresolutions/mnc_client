...
const OutsideInvReport: React.FC<ComponentProps> = ({ investigation }) => {
      ...
      }
        {
          investigation.length < 1 &&
            <Row className="h-100 align-items-center">
              <Col>
                  <h4 className='p-2 text-center text-danger'>Investigation Details are Empty.</h4>
              </Col>
            </Row>  
        } 
...
export default OutsideInvReport;

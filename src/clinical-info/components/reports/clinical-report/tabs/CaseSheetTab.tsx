...
const CaseSheetTab: React.FC<ComponentProps> = ({ patientVisit, screenDetails, setScreenDetails, getPatientVisitClinicalDetails }) => {
    return (
                                                        ...
                                                        <Row className='h-100 flex-column position-relative'>
                                                            {/* <Col className='flex-grow-0 sticky-top'>
                                                                <Row className='w-100 justify-content-between border rounded-top bg-light text-success pb-1'>
                                                                    <Col className='fw-bolder text-nowrap text-center fs-5 '>CaseSheets</Col>
                                                                </Row>
                                                            </Col> */}
                                                            <Col className=''>

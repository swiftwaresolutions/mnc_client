...
const PreviousPrescription = ({ show, onHide, previousPrescriptionNameList, handlePreviousPrescrionSelected,handlePresEdit, previousPrescriptionSelectedValue }: any) => {
  return (
    ...
    >
        <Modal.Header>
            <Row className='justify-content-around w-100'>
                ...
                <Col className='text-center'><Button variant='outline-info' onClick={()=>{handlePresEdit();onHide()}}>Add Prescription</Button></Col>
